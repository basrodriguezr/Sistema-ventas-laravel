					...
					<div class="login-form text-center text-white p-7 position-relative overflow-hidden">
						...
						<div class="login-signin">
							<div class="mb-20">
										...
										<h1 style="color:orange;">FOOD OK</h1>
								<p class="opacity-60 font-weight-bold" ; style="color:orange;">Ingrese sus datos para acceder:</p>
                            <form method="POST" action="{{ route('login') }}">
                                @csrf
								<div class="form-group">
									<input class="form-control h-auto text-white placeholder-white opacity-70 bg-dark-o-70 rounded-pill border-0 py-4 px-8 mb-5" type="email" placeholder="Correo electronico" name="email" id="email"/>
								</div>
								<div class="form-group">
									<input class="form-control h-auto text-white placeholder-white opacity-70 bg-dark-o-70 rounded-pill border-0 py-4 px-8 mb-5" type="password" placeholder="Contraseña" name="password" id="password"/>
								...
								<div class="form-group text-center mt-10">
									<button type="submit" class="btn btn-warning btn-outline-orange font-weight-bold  px-15 py-3">Ingresar</button>
								</div>
							</form>
							<div class="mt-10">
								<span class="mr-4" style="color:orange">Aún no tienes una cuenta?</span>
								<a href="{{ route('register') }}" id="kt_login_signup" class="font-weight-bolder" style="color:orange">Registrate Aqui!</a>
							</div>
						</div>
