            ...
            <div class="card-header">
                ...
                <div class="d-flex flex-row-reverse"><button
                        class="btn btn-sm btn-pill btn-outline-primary font-weight-bolder" id="createNewUser"><i
                            class="fas fa-plus"></i>Ingresar Usuario</button></div>
            </div>
            <div class="card-body">
                <div class="col-md-12">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title text-white" id="exampleModalLabel">Creación Usuario</h5>
            ...
            <div class="modal-body">
                <form id="formUser" name="formUser">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control" id="name" placeholder="Nombre"><br>
                        ...
                        <select name="level" class="form-control" id="level">
                            ...
                            <option value="2">Jefe de Caja</option>
